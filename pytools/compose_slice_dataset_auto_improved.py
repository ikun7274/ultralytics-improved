...
def stitch_group(img_paths, label_paths, output_img_path, output_txt_path):
    ...
    if len(set(widths)) != 1 or len(set(heights)) != 1:
        ...
        imgs = [img.resize((W_sub, H_sub), Image.Resampling.LANCZOS) for img in imgs]
...
def main():
    ...
    parser.add_argument("--input_dir", type=str, default=r"C:\Users\ROG\Desktop\human\base_0_0",
                        help="输入目录，应包含 images/ 和 labels/ 子目录（切片后数据）")
    parser.add_argument("--output_dir", type=str, default=r"C:\Users\ROG\Desktop\human\base_0_2",
                        help="输出目录，将自动创建 images/ 和 labels/ 存放合成结果")
