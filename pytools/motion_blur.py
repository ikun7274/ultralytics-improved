...
def process_folder(input_dir, output_dir,
    ...
    for file in files:
        ...
        cv2.imwrite(str(out_s), res_short)
        ...
        cv2.imwrite(str(out_l), res_long)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", default=r"C:\Users\ASUS\Desktop\ultralytics-main\test_images\images")
    parser.add_argument("--output_dir", default=r"C:\Users\ASUS\Desktop\ultralytics-main\test_images\motion_blur")
