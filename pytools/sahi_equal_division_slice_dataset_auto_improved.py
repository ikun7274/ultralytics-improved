...
def main():
    ...
    parser.add_argument("--orig_root", type=str,
                        default=r'C:\Users\ROG\Desktop\human\base_0_0',
                        help="原始 YOLO 数据集根目录")
    parser.add_argument("--coco_tmp", type=str,
                        default=r"C:\Users\ROG\Desktop\human\coco_temp",
                        help="临时 COCO 存放目录")
    parser.add_argument("--slice_coco_dir", type=str,
                        default=r"C:\Users\ROG\Desktop\human\slice_coco_output",
                        help="切片输出目录")
    parser.add_argument("--final_yolo_dir", type=str,
                        default=r"C:\Users\ROG\Desktop\human\base_0_1",
                        help="最终 YOLO 切片数据集输出目录")
    # 格式导出
